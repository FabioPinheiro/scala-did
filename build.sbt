...
inThisBuild(
  Seq(
    scalaVersion := "3.3.8", // Also update docs/publishWebsite.sh and any ref to scala-3.3.7
...
lazy val V = new {
  ...
  val zioHttp = "3.11.1" // With fix CORS https://github.com/zio/zio-http/pull/2490
