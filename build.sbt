...
inThisBuild(
  Seq(
    scalaVersion := "3.3.4", // Also update docs/publishWebsite.sh and any ref to scala-3.3.3
...
lazy val didImp = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // Add JVM-specific settings here
    ...
    libraryDependencies += "com.google.crypto.tink" % "tink" % "1.15.0", // https://mvnrepository.com/artifact/com.google.crypto.tink/tink/1.10.0
    // To fix vulnerabilitie https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-2976
    libraryDependencies += "com.google.protobuf" % "protobuf-java" % "4.28.3",
  )
  .jsConfigure(scalaJSLibConfigure)
  .jsSettings(
