...
lazy val V = new {
  ...
  val zioJson = "0.10.0"
  // val zioSchema = "1.8.2"
  val zioMunitTest = "0.4.1"
  val zioHttp = "3.11.6" // With fix CORS https://github.com/zio/zio-http/pull/2490
...
lazy val didResolverPeer = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // See dependencyTree ->  didResolverPeerJVM/Test/dependencyTree
    ...
    libraryDependencies += "org.bouncycastle" % "bcpkix-jdk18on" % "1.86" % Test,
