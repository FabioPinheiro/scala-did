...
lazy val V = new {
  ...
  val zioHttp = "3.10.1" // With fix CORS https://github.com/zio/zio-http/pull/2490
...
lazy val didImp = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // Add JVM-specific settings here
    ...
    libraryDependencies += "com.google.crypto.tink" % "tink" % "1.21.0", // https://mvnrepository.com/artifact/com.google.crypto.tink/tink/1.10.0
...
lazy val didResolverPeer = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // See dependencyTree ->  didResolverPeerJVM/Test/dependencyTree
    ...
    libraryDependencies += "org.bouncycastle" % "bcpkix-jdk18on" % "1.83" % Test,
...
lazy val didPrismNode = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.grpc" % "grpc-netty" % "1.80.0", // https://mvnrepository.com/artifact/io.grpc/grpc-netty
      "io.netty" % "netty-handler" % "4.2.12.Final", // This is to forces a update in from "io.grpc" % "grpc-netty" % "1.73.0" -> https://mvnrepository.com/artifact/io.netty/netty-handler/4.1.110.Final
