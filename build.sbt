...
lazy val didImp = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // Add JVM-specific settings here
    libraryDependencies += "org.bouncycastle" % "bcprov-jdk18on" % "1.78.1", // https://mvnrepository.com/artifact/org.bouncycastle/bcprov-jdk18on
    libraryDependencies += "org.bouncycastle" % "bcpkix-jdk18on" % "1.78.1", // https://mvnrepository.com/artifact/org.bouncycastle/bcpkix-jdk18on
...
lazy val didResolverPeer = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // See dependencyTree ->  didResolverPeerJVM/Test/dependencyTree
    ...
    libraryDependencies += "org.bouncycastle" % "bcprov-jdk18on" % "1.78.1" % Test,
    libraryDependencies += "org.bouncycastle" % "bcpkix-jdk18on" % "1.78.1" % Test,
