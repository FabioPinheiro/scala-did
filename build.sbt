...
lazy val didPrismNode = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.netty" % "netty-handler" % "4.2.14.Final", // This is to forces a update in from "io.grpc" % "grpc-netty" % "1.73.0" -> https://mvnrepository.com/artifact/io.netty/netty-handler/4.1.110.Final
