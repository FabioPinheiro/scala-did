...
inThisBuild(
  Seq(
    scalaVersion := "3.4.1", // Also update docs/publishWebsite.sh and any ref to scala-3.3.3
  )
)
// publish config
inThisBuild(
...
lazy val V = new {
  ...
  val zioHttp = "3.0.0-RC4" // FIXES CORS https://github.com/zio/zio-http/pull/2490
