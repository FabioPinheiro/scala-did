...
lazy val V = new {
  ...
  val zioHttp = "3.7.4" // FIXES CORS https://github.com/zio/zio-http/pull/2490
...
lazy val didImp = crossProject(JSPlatform, JVMPlatform)
  ...
  .jvmSettings( // Add JVM-specific settings here
    ...
    libraryDependencies += "com.google.protobuf" % "protobuf-java" % "4.33.5",
  )
  .jsConfigure(scalaJSLibConfigure)
  .jsSettings(
...
lazy val didPrismNode = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.grpc" % "grpc-netty" % "1.78.0", // https://mvnrepository.com/artifact/io.grpc/grpc-netty
