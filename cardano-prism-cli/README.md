...
```bash
alias cardano-prism='cs launch app.fmgp::cardano-prism-cli:1.0 -M fmgp.did.method.prism.cli.PrismCli --'

# Or with fewer JVM warnings
alias cardano-prism='cs launch --java-opt --sun-misc-unsafe-memory-access=allow app.fmgp::cardano-prism-cli:1.0 -M fmgp.did.method.prism.cli.PrismCli --'
