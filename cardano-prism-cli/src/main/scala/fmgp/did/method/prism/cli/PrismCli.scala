...
/** cardano-prism CLI
  ...
  * java -jar did-method-prism/jvm/target/scala-3.3.8/cardano-prism.jar indexer ../prism-vdr/preprod
  * shasum -a 256 did-method-prism/jvm/target/scala-3.3.8/cardano-prism.jar
  * }}}
  *
