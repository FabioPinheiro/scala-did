...
case class MySignedPrismEvent[+T <: OP](
    tx: String,
    b: Int,
    o: Int,
    signedWith: String,
...
// TODO replace MySignedPrismEvent
// case class CompresedSignedPrismEvent[+T <: OP](
//     tx: String,
//     b: Int,
//     o: Int,
//     signedWith: String,
//     signature: Array[Byte],
//     protobuf: PrismEvent,
// ) extends MaybeEvent[OP]
//     with PrismEventIndex {
//   lazy val event: T = OP.fromPrismEvent(protobuf).asInstanceOf[T] //FIXME
// }
